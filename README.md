# Awesome Cerebro with stars

> Curated list of Cerebro plugins and resources

*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 500,891 | 🐛 105 | 📅 2026-08-21.*
...
* [cerebro-file-search](https://github.com/lucky125111/cerebro-search-linux) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2020-04-05 - Cerebro plugin for fast file and folder search everywhere on your computer.
* [cerebro-mdn](https://github.com/tiagoamaro/cerebro-mdn) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2017-03-08 - Cerebro's plugin to search terms on MDN (Mozilla Developer Network).
* [cerebro-gitio](https://github.com/lubien/cerebro-gitio) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2021-10-08 - Shorten GitHub URLs with git.io.
* [cerebro-lol](https://github.com/DavidBernal/cerebro-lol) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2017-04-14 - Cerebro's plugin to search counters for League of Legends.
* [cerebro-qrcode](https://github.com/LaercioSantana/cerebro-qrcode) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2021-09-21 - Cerbero plugin to create QR Codes.
* [cerebro-rubygems](https://github.com/tiagoamaro/cerebro-rubygems) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2017-03-08 - Cerebro's plugin to search gems on Rubygems.
* [cerebro-hotel](https://github.com/lubien/cerebro-hotel) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2021-10-08 - Cerebro plugin that lets you start, stop and open Hotel apps.
* [cerebro-youdao](https://github.com/lcjnil/cerebro-youdao) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2017-05-07 - Cerebro's plugin to translate via youdao dict.
* [cerebro-filmaffinity](https://github.com/jnavb/cerebro-filmaffinity) ⭐ 2 | 🐛 1 | 🌐 JavaScript | 📅 2018-08-24 - Cerebro plugin to search movie info from filmaffinity webpage.
* [cerebro-base2x16](https://github.com/berthin/cerebro-base2x16) ⭐ 1 | 🐛 2 | 🌐 JavaScript | 📅 2023-07-11 - Converts a number to decimal, hexadecimal, and binary bases.
* [cerebro-define](https://github.com/glja021/cerebro-define) ⭐ 1 | 🐛 5 | 🌐 JavaScript | 📅 2018-04-04 - A Cerebro plugin to quickly look up the meaning of a word.
* [cerebro-copy](https://github.com/lcjnil/cerebro-copy) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2017-06-05 - Cerebro's plugin to copy text to clipboard.
* [cerebro-blockchain](https://github.com/tim-hub/cerebro-blockchain) ⭐ 1 | 🐛 20 | 🌐 JavaScript | 📅 2022-12-10 - A cerebro plugin to get the blockchain states and information.
* [cerebro-thingiverse](https://github.com/fcannizzaro/cerebro-thingiverse) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2021-07-15 - Cerebro plugin to find 3d things on [thingiverse](https://www.thingiverse.com/).
* [cerebro-ecosia](https://github.com/dubisdev/cerebro-ecosia) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2022-08-18 - Cerebro plugin to Search with Ecosia.
* [cerebro-recipes](https://github.com/wolfika/cerebro-recipes) ⚠️ Archived - Cerebro plugin to find food and drink recipes using the Recipe Puppy API.
* [cerebro-baidu](https://github.com/aak1247/cerebro-baidu) ⭐ 0 | 🐛 13 | 🌐 JavaScript | 📅 2022-12-09 - Cerebro plugin to search in baidu.
...
* [cerebro-lipsum](https://www.npmjs.com/package/cerebro-lipsum) - Cerebro plugin to generate lorem ipsum text from [www.lipsum.com](http://www.lipsum.com).
...
* [create-cerebro-plugin](https://github.com/KELiON/create-cerebro-plugin) ⭐ 28 | 🐛 0 | 🌐 JavaScript | 📅 2022-12-11 - set of tools to create Cerebro plugins.
* [cerebro-plugin-boilerplate](https://github.com/dubisdev/cerebro-plugin-boilerplate) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2022-05-18 - Updated cerebro plugin template with a faster and customizable build system.

## Articles

* [Building Small Apps with React - Cerebro](https://github.com/BrainMaestro/primer/blob/master/react/building-small-apps-with-react-cerebro.md) ⭐ 19 | 🐛 1 | 📅 2017-03-21.

## Tools

* [Cerebro Plugins](https://github.com/lubien/cerebro-plugins) ⭐ 12 | 🐛 2 | 🌐 JavaScript | 📅 2021-10-08 - Cerebro plugin list WebApp.
